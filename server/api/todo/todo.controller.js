...
// curl http://localhost:5000/api/todo/update -X POST -H "Content-Type: application/json" -d '{"id": "56ff521f5edc574e072e6c46", "complete": 1, "text": "test"}'
exports.update = function(req, res) {
    ...
    Todo.update(whereStatement, updateStatement, function(err) {
        if (err) {
            ...
            res.send({status: "ok", result: todo});
        }
    });
};
